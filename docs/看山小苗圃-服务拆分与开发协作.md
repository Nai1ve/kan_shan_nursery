...
| llm_task_cache | llm-service | API |
| zhihu_api_cache | zhihu-adapter | API |
...
sequenceDiagram
  ...
  Content->>Zhihu: GET hot/search/following cached
  Content->>LLM: summarize / controversies / writing angles cached
